...
class ApplicationForAdmission extends Component {
    ...
    componentDidMount() {
        ...
        // if (query && query.inHospTableId) {
        //
        //     // this.props.agent.setPageTempObj({record:{...record},text:'编辑角色'});
    ...
    setPageTempObj(object={}){
        this.props.agent.setPageTempObj(this,{...object});
    }
        ...
        return (
            <div className={`winning-body ${style.winningBody}`} ref={this.inside}>
                <div className='winning-content'>
                    <BreadcrumbCustom first="康复" second="流程待办" third="康复入院申请" secondUrl={this.state.backUrl}/>
                    <Divider/>
                    ...
                    <div className={isHidePrint ?  style.tabContent : style.tabContent +' '+style.showPrint} ref={(el) => {this.refs = el}} >
                        <div name="tab1" className={(tabValue == "0") ? '' : style.hidden}
                            ...
                            <div className={style.tableStyle}>
                                <title>上级医院病历</title>
                                <UploadFile successCallback ={this.setApplyFile}
                                                  self={this}
                        ...
                        <div name="tab3" className={(tabValue == "2") ? '' : style.hidden}
                            ...
                            <div className={style.tableStyle}>
                                ...
                                <UploadFile successCallback ={this.setBergFile}
